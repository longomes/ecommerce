...
$app->get('/boleto/:idorder', function($idorder) {
	...
	// NÃO ALTERAR!
	$path = $_SERVER['DOCUMENT_ROOT'] . 'resources/boletophp/include';
...
$app->post('/profile/change-password', function(){
	...
	if (!isset($_POST['new_pass_confirm']) || 
	...
	if ($_POST['new_pass'] !== $_POST['new_pass_confirm']) {
		User::setError('Nova Senha e Confirme a Nova Senha devem ser iguais.');
	...
	$update = new User;
	$update->getById($user->getiduser());

	$_SESSION[User::SESSION]['despassword'] = $update->getdespassword();
